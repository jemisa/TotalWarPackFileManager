...
namespace VariantMeshEditor.Views.TexturePreview
{
    ...
    class TexturePreviewController
    {



        public static void Create(string imagePath, TextureToTextureRenderer textureToTextureRenderer, ResourceLibary resourceLib)
        {
            ...
            var controller = new TexturePreviewController(imagePath, textureToTextureRenderer, resourceLib, viewModel);
        ...
        public TexturePreviewController(string imagePath, TextureToTextureRenderer textureToTextureRenderer, ResourceLibary resourceLib, TexturePreviewViewModel viewModel)
        {
            _imagePath = imagePath;
            _resourceLib = resourceLib;
            _textureRenderer = textureToTextureRenderer;
        ...
        void CreateImage()
        {
            var texture = _resourceLib.LoadTexture(_imagePath, null);
        ...
        {
            var file = PackFileLoadHelper.FindFile(_resourceLib.PackfileContent, fileName);
            if (file == null)
                return null;
